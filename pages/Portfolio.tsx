  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className=" relative w-full py-[70px]  overflow-y-hidden snap-x snap-mandatory  ">
          <div className="overflow-x-scroll flex  scrollbar-thumb-[#39ff14]  scrollbar-thin scrollbar-track-gray-400/20  ">
            {data.projects.map((project, i) => (
              ...
              > <m.div initial={{
                  ...
                  <img
                    ...
                    className="cursor-pointer object-cover rounded-[] h-[90px]"
                    src={project.Image}
                    alt="project image"
                  />
                </Link>
